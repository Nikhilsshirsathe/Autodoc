    ...
    <div className="min-h-screen flex">
      <div className="hidden lg:flex w-[480px] shrink-0 flex-col bg-primary p-12 text-primary-foreground">
        <div className="flex items-center gap-2.5 mb-auto">
          ...
          <span className="text-lg font-semibold">AUTODOC</span>
        </div>
        <div className="space-y-6">
          <div>
            <h1 className="text-3xl font-bold leading-tight">Prepare your SEBI SME IPO with confidence.</h1>
            <p className="mt-4 text-primary-foreground/70 leading-relaxed">AUTODOC automates offer document preparation using AI — from document classification to DRHP draft generation.</p>
          </div>
